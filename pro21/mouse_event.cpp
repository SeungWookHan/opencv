...
void make_palette(int pos_y, Rect rect)
{
	...
	float ratio1 = 180.0f / rect.height; // hue ���� ������
	float ratio2 = 256.0f / rect.width;	 // saturation ���� ������
	float ratio3 = 256.0f / rect.height; // intensity ���� ������
	...
	cvtColor(palatte, palatte, COLOR_HSV2BGR);
}
...
void pallette_index(Rect rect)
{
	...
	cvtColor(p_index, p_index, COLOR_HSV2BGR);
}
