...
int main()
{
    ...
    // Read image
    Mat img = imread("/Users/Han/programming/opencv/pro18/sample.jpeg", 0);
    ...
    if (h % 2 == 0)
        ...
        h2 = h + 1;
    copyMakeBorder(img, img2, 0, h2 - h, 0, w2 - w, BORDER_REPLICATE);
    ...
    cv::putText( dst, txt, Point(10,20),
     CV_FONT_HERSHEY_SIMPLEX, 0.5, CV_RGB(0,0,0) );*/
        ...
        //char fname[500];
        //sprintf(fname, "C:/Users/Chandu/Documents/Visual Studio 2010/Projects/dct/dct/idct_%04d.bmp", Start);
        imshow("dst.jpg", dst);
        imwrite("idist.jpg", dst);
    }
