...
int main()
{
    image = imread("/Users/Han/programming/opencv/pro16/rotate_test.jpg", 0);
...
//     {
//         Point dt = Point(x, y) - pt1;

//         Mat dst;
//         Matx23f trans_map(1, 0, dt.x, 0, 1, dt.y);
//         warpAffine(image, dst, trans_map, image.size());
...
//     {
//         Mat tmp = image.clone();
//         line(tmp, pt1, Point(x, y), Scalar(0, 255, 0), 2);
//         imshow(title, tmp);
//     }
// }
